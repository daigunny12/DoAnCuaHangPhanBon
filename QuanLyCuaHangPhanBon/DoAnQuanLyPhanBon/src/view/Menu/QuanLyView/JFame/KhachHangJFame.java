...
import Controller.QuanLy.Add.KhachHangController;
...
public class KhachHangJFame extends javax.swing.JFrame {
    ...
    public KhachHangJFame(KhachHangObj khachHangObj, KhachHangJPanel khachHangJPanel) {
        initComponents();
        KhachHangController controller = new KhachHangController(btnSave, lblThongBao, txtTen, txtMa, txtSoNo, txtSDT, txtDiaChi, txtGhiChu);

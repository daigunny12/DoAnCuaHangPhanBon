...
import Controller.QuanLy.Add.NhaCungCapController;
...
public class NhaCungCapJFame extends javax.swing.JFrame {
    ...
    public NhaCungCapJFame(NhaCungCapObj nhaCungCapObj, NhaCungCapJPanel nhaCungCapJPanel ) {
        initComponents();
        NhaCungCapController controller = new NhaCungCapController(btnSave, lblThongBao, txtTen, txtMa, txtSoNo, txtSDT, txtDiaChi, txtGhiChu);

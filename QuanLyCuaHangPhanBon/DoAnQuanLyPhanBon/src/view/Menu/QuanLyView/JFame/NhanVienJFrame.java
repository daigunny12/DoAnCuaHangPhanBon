...
import Controller.QuanLy.Add.NhanVienController;
...
public class NhanVienJFrame extends javax.swing.JFrame {
    ...
    public NhanVienJFrame(NhanVienObj nhanVienObj, NhanVienJPanel nhanVienJPanel) {
        initComponents();
        NhanVienController controller = new NhanVienController(btnSave, lblThongBao, txtTen, txtMa, jDateChooser1, rdoNam, rdoNu, txtSDT, txtDiaChi, txtGhiChu);

...
public class QuanLyNhanVienController {
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && table.getSelectedRow() != -1) {
                    ...
                    NhanVienJFrame nhanVienJFrame = new NhanVienJFrame(nhanVienObj, NhanVienJPanel.it);
    ...
    public void setEvent() {
        btnAdd.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                NhanVienJFrame nhanVienJFrame = new NhanVienJFrame(new NhanVienObj(), NhanVienJPanel.it);
                nhanVienJFrame.setTitle("Thông tin nhân viên");
                nhanVienJFrame.setResizable(false);
                nhanVienJFrame.setVisible(true);
                nhanVienJFrame.setLocationRelativeTo(null);

   ...
   public TableCellRenderer phoneNumberRendenrer = new PhoneNumberRendenrer();
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && table.getSelectedRow() != -1) {
                    ...
                    khachHangObj.setSoNo((float) model.getValueAt(selectedRowIndex, 5));
                    khachHangObj.setGhiChu(model.getValueAt(selectedRowIndex, 6).toString());

                    KhachHangJFame khachHangJFame = new KhachHangJFame(khachHangObj, KhachHangJPanel.it);
                    khachHangJFame.setTitle("Thông tin khách hàng");
                    khachHangJFame.setResizable(false);
                    khachHangJFame.setVisible(true);
                    khachHangJFame.setLocationRelativeTo(null);
                }
            }
    ...
    public void setEvent() {
        btnAdd.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                KhachHangJFame khachHangJFame = new KhachHangJFame(new KhachHangObj(), KhachHangJPanel.it);
                khachHangJFame.setTitle("Thông tin Khách hàng");
                khachHangJFame.setResizable(false);
                khachHangJFame.setVisible(true);
                khachHangJFame.setLocationRelativeTo(null);

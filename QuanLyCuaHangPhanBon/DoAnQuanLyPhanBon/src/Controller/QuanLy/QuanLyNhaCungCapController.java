   ...
   public TableCellRenderer phoneNumberRendenrer = new PhoneNumberRendenrer();
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 2 && table.getSelectedRow() != -1) {
                    ...
                    nhaCungCapObj.setSoNo((float) model.getValueAt(selectedRowIndex, 5));
                    nhaCungCapObj.setGhiChu(model.getValueAt(selectedRowIndex, 6).toString());

                    NhaCungCapJFame nhaCungCapJFame = new NhaCungCapJFame(nhaCungCapObj, NhaCungCapJPanel.it);
                    nhaCungCapJFame.setTitle("Thông tin nhà cung cấp");
                    nhaCungCapJFame.setResizable(false);
                    nhaCungCapJFame.setVisible(true);
                    nhaCungCapJFame.setLocationRelativeTo(null);
                }
            }
    ...
    public void setEvent() {
        btnAdd.addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                NhaCungCapJFame nhaCungCapJFame = new NhaCungCapJFame(new NhaCungCapObj(), NhaCungCapJPanel.it);
                nhaCungCapJFame.setTitle("Thông tin nhà cung cấp");
                nhaCungCapJFame.setResizable(false);
                nhaCungCapJFame.setVisible(true);
                nhaCungCapJFame.setLocationRelativeTo(null);

...
public class NhaCungCapController {
    ...
    public NhaCungCapController(JButton btnSave, JLabel lblThongBao, JTextField txtTen, JTextField txtMa, JTextField txtSoNo, JTextField txtSDT, JTextArea txtDiaChi, JTextArea txtGhiChu) {
    ...
    public void setView(NhaCungCapObj nhaCungCapObj) {
        ...
        txtSoNo.setText("" + nhaCungCapObj.getSoNo());

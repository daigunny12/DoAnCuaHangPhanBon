...
public class KhachHangController {
    ...
    public KhachHangController(JButton btnSave, JLabel lblThongBao, JTextField txtTen, JTextField txtMa, JTextField txtSoNo, JTextField txtSDT, JTextArea txtDiaChi, JTextArea txtGhiChu) {
    ...
    public void setView(KhachHangObj khachHangObj){
        ...
        txtSoNo.setText(""+khachHangObj.getSoNo());

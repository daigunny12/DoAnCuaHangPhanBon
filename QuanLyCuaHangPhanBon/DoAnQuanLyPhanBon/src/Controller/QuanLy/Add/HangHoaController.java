...
public class HangHoaController {
    ...
    private JTextField txtGiaBanSi;
    private JTextField txtGiaBanLe;
    ...
    public HangHoaController(JButton btnSave, JLabel lblThongBao, JTextField txtTen, JTextField txtMa, JTextField txtDVT, JTextField txtSL, JTextField txtGiaBanSi, JTextField txtGiaBanLe, JTextField txtGiaMua, JTextField txtGhiChu) {
    ...
    public void setView(HangHoaObj hangHoaObj) {
        ...
        txtGiaBanSi.setText(hangHoaObj.getGiaBanSi() + "");
        txtGiaBanLe.setText(hangHoaObj.getGiaBanLe() + "");
        txtGiaMua.setText(hangHoaObj.getGiaMua() + "");
    ...
    public void LuuGiaTri(HangHoaJPanel hangHoaJPanel) {
        ...
        float gbl = Float.parseFloat(txtGiaBanLe.getText());
        float gbs = Float.parseFloat(txtGiaBanSi.getText());
        float gm = Float.parseFloat(txtGiaMua.getText());
        int sl = Integer.parseInt(txtSL.getText());
        hangHoaObj.setGiaBanLe(gbl);
        hangHoaObj.setGiaBanSi(gbs);
